...
info:
  description: >-
    ...
    resource combined with a method and that's it! We will explain what is going
    on
    ...
    **Note:** As we progress through the examples, do not also forget to view
    the
    ...
    Also please keep in mind that every single example in this course is a
    **real
    ...
    + [This: Raw API
    Blueprint](https://raw.github.com/apiaryio/api-blueprint/master/examples/01.%20Simplest%20API.md)
